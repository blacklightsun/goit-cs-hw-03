...
def create_task():
    return f"INSERT INTO tasks(title, description, status_id, user_id) VALUES ('{faker.sentence(5)}', '{faker.text(100)}', '{random.choice(status_id_list)}', '{random.choice(user_id_list)}')"
